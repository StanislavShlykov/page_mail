...
from .views import NewsList, NewsDetail, PostCreate, PostUpdate, PostDelete, NewsSearch, NewsCreate,content, ArticlesList, ArticlesDetail, sign_me


urlpatterns = [
   path('', content),
   path('news/', NewsList.as_view()),
   path('news/sign_me/', sign_me, name='sign_me'),
